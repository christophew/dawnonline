    ...
    public abstract class RoomCacheBase
    {
        ...
        private class RoomInstance
        {
            ...
            public RoomReference AddReference(PeerBase ownerPeer)
            {
                ...
                this.logQueue.Add(
                    new LogEntry(
                        "AddReference", string.Format("RoomName={0}, ReferenceCount={1}, OwnerPeer={2}", this.Room.Name, this.ReferenceCount, ownerPeer)));
            ...
            public void ReleaseReference(RoomReference reference)
            {
                ...
                this.logQueue.Add(
                    new LogEntry(
                        "ReleaseReference",
                        string.Format("RoomName={0}, ReferenceCount={1}, OwnerPeer={2}", this.Room.Name, this.ReferenceCount, reference.OwnerPeer)));
            }
