...
namespace Photon.CounterPublisher
{
    public static class SocketServerCounterSchema
    {
        ...
        public class EndNode
        {
            ...
            public static readonly string CategoryName = "Photon Socket Server: EndNode";

            public static readonly string EndNodeBytesInCounter = "EndNode: Bytes in";

            public static readonly string EndNodeBytesInPerSecondCounter = "EndNode: Bytes in/sec";

            public static readonly string EndNodeBytesOutCounter = "EndNode: Bytes out";

            public static readonly string EndNodeBytesOutPerSecondCounter = "EndNode: Bytes out/sec";

            public static readonly string EndNodeConnectionsActiveCounter = "EndNode: Connections Active";

            public static readonly string EndNodeFlowControl25Counter = "EndNode: Flow Control 25%";

            public static readonly string EndNodeFlowControl50Counter = "EndNode: Flow Control 50%";

            public static readonly string EndNodeFlowControl75Counter = "EndNode: Flow Control 75%";

            public static readonly string EndNodeFlowControlActiveCounter = "EndNode: Flow Control Active";

            public static readonly string EndNodeFlowControlBufferFullCounter = "EndNode: Flow Control Buffer Full Events";

            public static readonly string EndNodeFlowControlBufferQueueCounter = "EndNode: Flow Control Buffer Queue";

            public static readonly string EndNodeFlowControlBufferQueueMinusPerSecondCounter = "EndNode: Flow Control Buffer Queue -/sec";

            public static readonly string EndNodeFlowControlBufferQueuePlusPerSecondCounter = "EndNode: Flow Control Buffer Queue +/sec";

            public static readonly string EndNodePeersCounter = "EndNode: Peers";
        ...
        public class Proxy
        {
            ...
            public static readonly string CategoryName = "Photon Socket Server: Proxy";

            public static readonly string ProxyInBytesInCounter = "ProxyIn: Bytes in";

            public static readonly string ProxyInBytesInPerSecondCounter = "ProxyIn: Bytes in/sec";

            public static readonly string ProxyInBytesOutCounter = "ProxyIn: Bytes out";

            public static readonly string ProxyInBytesOutPerSecondCounter = "ProxyIn: Bytes out/sec";

            public static readonly string ProxyInConnectionsActiveCounter = "ProxyIn: Connections Active";

            public static readonly string ProxyInFlowControl25Counter = "ProxyIn: Flow Control 25%";

            public static readonly string ProxyInFlowControl50Counter = "ProxyIn: Flow Control 50%";

            public static readonly string ProxyInFlowControl75Counter = "ProxyIn: Flow Control 75%";

            public static readonly string ProxyInFlowControlActiveCounter = "ProxyIn: Flow Control Active";

            public static readonly string ProxyInFlowControlBufferFullCounter = "ProxyIn: Flow Control Buffer Full Events";

            public static readonly string ProxyInFlowControlBufferQueueCounter = "ProxyIn: Flow Control Buffer Queue";

            public static readonly string ProxyInFlowControlBufferQueueMinusPerSecondCounter = "ProxyIn: Flow Control Buffer Queue -/sec";

            public static readonly string ProxyInFlowControlBufferQueuePlusPerSecondCounter = "ProxyIn: Flow Control Buffer Queue +/sec";

            public static readonly string ProxyInTimeoutDisconnectsCounter = "ProxyIn: Timeout Disconnects";

            public static readonly string ProxyOutBytesInCounter = "ProxyOut: Bytes in";

            public static readonly string ProxyOutBytesInPerSecondCounter = "ProxyOut: Bytes in/sec";

            public static readonly string ProxyOutBytesOutCounter = "ProxyOut: Bytes out";

            public static readonly string ProxyOutBytesOutPerSecondCounter = "ProxyOut: Bytes out/sec";

            public static readonly string ProxyOutConnectionsActiveCounter = "ProxyOut: Connections Active";

            public static readonly string ProxyOutFlowControl25Counter = "ProxyOut: Flow Control 25%";

            public static readonly string ProxyOutFlowControl50Counter = "ProxyOut: Flow Control 50%";

            public static readonly string ProxyOutFlowControl75Counter = "ProxyOut: Flow Control 75%";

            public static readonly string ProxyOutFlowControlActiveCounter = "ProxyOut: Flow Control Active";

            public static readonly string ProxyOutFlowControlBufferFullCounter = "ProxyOut: Flow Control Buffer Full Events";

            public static readonly string ProxyOutFlowControlBufferQueueCounter = "ProxyOut: Flow Control Buffer Queue";

            public static readonly string ProxyOutFlowControlBufferQueueMinusPerSecondCounter = "ProxyOut: Flow Control Buffer Queue -/sec";

            public static readonly string ProxyOutFlowControlBufferQueuePlusPerSecondCounter = "ProxyOut: Flow Control Buffer Queue +/sec";
