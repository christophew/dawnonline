...
namespace Lite.Tests.Disconnected
{
    ...
    public class BasicUseCases
    {
        ...
        public void JoinAndJoin()
        {
            ...
            var litePeerOne = new LitePeer(peerOne.Protocol, peerOne);
            var litePeerTwo = new LitePeer(peerTwo.Protocol, peerTwo);
        ...
        public void RaiseEventActors()
        {
            ...
            var litePeerOne = new LitePeer(peerOne.Protocol, peerOne);
            var litePeerTwo = new LitePeer(peerTwo.Protocol, peerTwo);
            var litePeerThree = new LitePeer(peerThree.Protocol, peerThree);
        ...
        public void RaiseEventCacheMerge()
        {
            ...
            try
            {
                ...
                Assert.AreEqual(Code, @event.Code);
                var @eventData = (Hashtable)@event.Parameters[(byte)ParameterKey.Data];
                Assert.AreEqual((byte)CacheOperation.MergeCache, @event.Parameters[(byte)ParameterKey.Cache]);
                Assert.AreEqual("value1", @eventData[1]);
        ...
        public void RaiseEventCacheRemove()
        {
            ...
            try
            {
                ...
                var @eventData = (Hashtable)@event.Parameters[(byte)ParameterKey.Data];
                Assert.AreEqual("value1", @eventData[1]);
                Assert.AreEqual((byte)CacheOperation.ReplaceCache, @event.Parameters[(byte)ParameterKey.Cache]);
                ...
                Assert.AreEqual(code, @event.Code);
                @eventData = (Hashtable)@event.Parameters[(byte)ParameterKey.Data];
                Assert.AreEqual((byte)CacheOperation.RemoveCache, @event.Parameters[(byte)ParameterKey.Cache]);
        ...
        public void RaiseEventCacheRoom()
        {
            ...
            try
            {
                ...
                Assert.AreEqual(Code, @event.Code);
                var @eventData = (Hashtable)@event.Parameters[(byte)ParameterKey.Data];
                Assert.AreEqual((byte)CacheOperation.AddToRoomCache, @event.Parameters[(byte)ParameterKey.Cache]);
                Assert.AreEqual("value1", @eventData[1]);
        ...
        private static void JoinPeer(DummyPeer peer, LitePeer litePeer, int expectedNumber)
        {
        ...
        ///   The expected number.
        /// </param>
        private static void JoinPeer(DummyPeer peer, LitePeer litePeer, int expectedNumber, Dictionary<byte, object> customParameters)
        {
