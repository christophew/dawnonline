...
namespace Lite
{
    ...
    public class LiteGame : Room
    {
        ...
        private readonly Dictionary<int, EventCache> eventCacheOld = new Dictionary<int, EventCache>();

        private readonly RoomEventCache eventCache = new RoomEventCache();

        private readonly Dictionary<byte, ActorGroup> actorGroups = new Dictionary<byte, ActorGroup>();
