...
namespace DawnOnline.Simulation.Collision
{
    ...
    internal static class CollisionDetection
    {
        ...
        static public PolygonCollisionResult PolygonCollision(Polygon polygonA, Polygon polygonB, Vector velocity)
        {
        ...
        static private float IntervalDistance(float minA, float maxA, float minB, float maxB)
        {
            if (minA < minB)
            {
                return minB - maxA;
        ...
        static private void ProjectPolygon(Vector axis, Polygon polygon, ref float min, ref float max)
        {
