...
using TestPhotonApp.Operations;

namespace TestPhotonApp
{
    public class TestPeer : LitePeer
    {
        ...
        public TestPeer(IRpcProtocol rpcProtocol, IPhotonPeer peer)
        ...
        {
            return TestGameCache.Instance.GetRoomReference(joinRequest.GameId, this);
        }
